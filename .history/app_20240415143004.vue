...
div(class="h-screen w-100 bg-no-repeat bg-cover bg-bottom relative bg-[url('https://carconfigurator.ferrari.com/assets/cars/portofinom/packages/default/car-ferrari-portofino-m_splash.jpg')]")
  div(class="z-10 absolute w-full h-full justify-center items-center")
    div(class="text-center w-1/2"): h1(class="text-8xl font-serif mb-10 text-white") Find your drive 
  div(class="z-1 absolute w-full h-full bg-black opacity")
